...
MODEL_PATHS = [
    ...
    "easy_xlmr_large_256/checkpoint-5844"#,
    #"models/results_xlmr_longer_train\checkpoint-7792"
    #"results_augmentedchatgpt_xlmr_large_optimized"
    #"easy_xlmr_large_256/checkpoint-4870",
    #"results_augmentedchatgpt_xlmr_large_optimized/checkpoint-4895",
    #"results_augmentedchatgpt_xlmr_large_optimized/checkpoint-5868"
    # ... ajoute d'autres chemins relatifs
]
...
if not all(len(preds) == len(texts_to_predict) for preds in all_model_preds):
     ...
     # Tenter de corriger ou lever une erreur ? Pour l'instant, on continue mais le résultat sera potentiellement faux.
     # Il serait peut-être mieux de lever une erreur ici.
...
if "label" in df.columns:
    ...
    if evaluation_possible:
        # ... (calculs et logs des métriques identiques) ...
        y_true = df['label']
        ...
        if "language" in df.columns:
            # ... (évaluation par langue identique) ...
            pass # Placeholder, code identique à la version précédente
        else:
